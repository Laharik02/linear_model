...
model.save("regression4")


print("Weights without regularization (Model 4):\n", model.weights)


# Plot training loss
plt.plot(model.loss_per_cycle, label="No Regularization")
plt.legend()
plt.title("Training Loss (Model 4)")
plt.xlabel("Epochs(Iterations)")
plt.ylabel("MSE( Average Loss)")
plt.savefig("regression4_loss.png")
print("Model 4 trained and saved. Loss plot saved as regression4_loss.png")
plt.show()